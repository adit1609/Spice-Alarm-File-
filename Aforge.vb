...
Public Class Aforge
    ...
    Private Sub Guna2Button1_Click(sender As Object, e As EventArgs) Handles Guna2Button1.Click
        If Not BackgroundWorker1.IsBusy Then
            Guna2Button1.Enabled = False ' Disable the button
    ...
    Private Sub BackgroundWorker1_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        ...
        While Not BackgroundWorker1.CancellationPending
            ' Background task is running; check for cancellation requests
            System.Threading.Thread.Sleep(100) ' Simulate work with a delay
        End While
    ...
    Private Sub BackgroundWorker1_RunWorkerCompleted(sender As Object, e As RunWorkerCompletedEventArgs) Handles BackgroundWorker1.RunWorkerCompleted
        ...
        If e.Cancelled Then
            ' The task was canceled. Re-enable the buttons.
    ...
    Private Sub Guna2Button2_Click(sender As Object, e As EventArgs) Handles Guna2Button2.Click
        ...
        ' Disable Button2 to prevent multiple clicks while waiting
